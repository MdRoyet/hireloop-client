...
export default function SignIn() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Logging in via Better-Auth:", formData);
  };
      ...
      <div className="grid min-h-screen w-full place-items-center p-4">
        <main className="w-full max-w-md bg-[#0f0f11] border border-white/5 rounded-2xl p-6 sm:p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full border border-white/10 bg-black/40 py-2.5 pl-10 pr-4 text-sm text-white placeholder-gray-600 rounded-xl outline-none focus:border-purple-500"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full border border-white/10 bg-black/40 py-2.5 pl-10 pr-10 text-sm text-white placeholder-gray-600 rounded-xl outline-none focus:border-purple-500"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              className="w-full bg-white text-black text-sm font-semibold py-3 px-4 rounded-xl shadow-xl hover:bg-gray-200 active:scale-[0.99] transition-all transform duration-150 cursor-pointer mt-2"
            >
              Sign In
            </button>
          </form>
